...
public class MembersController {
  ...
  public ResponseEntity<MemberResponse> updateMemberRole(
    ...
    return ResponseEntity.ok(
        memberService.updateMemberRole(walletID, memberID, request, user.getId()));
  }
  ...
  @GetMapping()
  public ResponseEntity<List<WalletInviteResponse>> getInvites(@AuthenticationPrincipal User user) {
