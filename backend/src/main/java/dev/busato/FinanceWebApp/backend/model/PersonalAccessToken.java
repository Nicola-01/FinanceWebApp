 ...
 * <p>
 * The plain token is NEVER stored — only its SHA-256 hash is persisted.
 * Wallet-level permissions are stored as a JSON string in a TEXT column.
 */
@Data
@Builder
@NoArgsConstructor
...
public class PersonalAccessToken {
    ...
    /**
     * JSON-encoded wallet permissions.
     * Format: [{"walletId":"uuid","permissions":["READ","WRITE"]}]
     */
