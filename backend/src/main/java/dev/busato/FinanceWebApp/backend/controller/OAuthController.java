 ...
 * Ordinati in ordine di esecuzione reale del flusso OAuth:
 * <p>
 * FLUSSO COMPLETO:
 * <pre>
 ...
 * </pre>
 * <p>
 * OAuth è solo il trasporto per ottenere il token — l'access_token finale
 * è un PAT standard, identico a quello del flusso copia-incolla.
 * I due flussi coesistono senza conflitti.
 */
@RestController
