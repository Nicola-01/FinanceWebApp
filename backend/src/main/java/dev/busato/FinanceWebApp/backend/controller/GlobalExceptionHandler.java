...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ProblemDetail> handleTagInUseException(
      TagInUseException ex, HttpServletRequest request) {
  ...
  public ResponseEntity<ProblemDetail> handleValidationException(
    ...
    ProblemDetail problemDetail =
        ProblemDetail.forStatusAndDetail(HttpStatus.BAD_REQUEST, "Invalid input data");
  ...
  public ResponseEntity<ProblemDetail> handleGenericException(
    ...
    // Log the actual exception for internal debugging, but DO NOT expose the message or stack trace
    // to the client
  ...
  /**
   * Constructs the standardised ProblemDetail response. * @param ex The captured exception
   *
