...
public class SubscriptionController {
    ...
    @GetMapping("/{walletID}")
    public ResponseEntity<List<SubscriptionResponse>> getSubscriptionByWallet(@PathVariable UUID walletID, @AuthenticationPrincipal User user) {
        return ResponseEntity.ok(subscriptionService.getSubscriptionsByWalletID(walletID, user.getId()));
    }
    ...
    public ResponseEntity<SubscriptionResponse> createSubscription(@RequestBody SubscriptionRequest request,
        ...
        return ResponseEntity.ok(subscriptionService.createSubscription(request, walletID, user.getId()));
    }
    ...
    public ResponseEntity<SubscriptionResponse> updateSubscription(
        ...
        return ResponseEntity.ok(subscriptionService.updateSubscription(subscriptionID, request, walletID, user.getId()));
    }
