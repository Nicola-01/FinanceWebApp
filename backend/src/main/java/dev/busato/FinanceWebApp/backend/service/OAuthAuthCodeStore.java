 ...
 * <p>
 * Auth codes are short-lived (5 minutes), single-use, and link to a
 * user's PAT plain token value for the token exchange step.
 * <p>
 * This implementation is suitable for single-instance deployments.
 * For multi-instance setups behind a load balancer, replace with a
...
public class OAuthAuthCodeStore {
     ...
     * stores the entry, and returns the code.
     */
    ...
    /**
     * Consumes (retrieves and deletes) an authorization code.
     * Returns empty if the code doesn't exist or has expired.
     * This ensures single-use: the code is deleted atomically.
     */
    ...
    /**
     * Scheduled cleanup: removes expired entries every 60 seconds.
     * Prevents memory leaks from unclaimed authorization codes.
     */
