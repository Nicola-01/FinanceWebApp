...
class WalletSecurityTest {
  ...
  @InjectMocks private WalletSecurity walletSecurity;
  ...
  void isWalletOwner_UserIsOwnerAndNoPat_ReturnsTrue() {
    ...
    when(walletAccessRepository.findByUserIdAndWalletId(userId, walletId))
        .thenReturn(Optional.of(mockAccess));
  ...
  void isWalletOwner_UserIsAdmin_ThrowsPermissionDeniedException() {
    ...
    assertThrows(
        PermissionDeniedException.class, () -> walletSecurity.isWalletOwner(userId, walletId));
  }
  ...
  void hasWriteAccess_UserIsViewer_ThrowsPermissionDeniedException() {
    ...
    assertThrows(
        PermissionDeniedException.class, () -> walletSecurity.hasWriteAccess(userId, walletId));
  }
  ...
  @Test
  void hasWriteAccess_WithPatPermissionForDifferentWallet_ThrowsPermissionDeniedException()
      throws Exception {
    mockAccess.setRole(WalletAccess.WalletRole.EDITOR);
    mockAccess.setStatus(WalletAccess.InvitationStatus.ACCEPTED);
    when(walletAccessRepository.findByUserIdAndWalletId(userId, walletId))
    ...
    pat.setWalletPermissions(
        "[{\"walletId\":\"" + differentWalletId + "\", \"permissions\":[\"WRITE\"]}]");
    setupSecurityContext(pat);
  ...
  void hasReadAccess_UserIsPending_ThrowsPermissionDeniedException() {
    ...
    assertThrows(
        PermissionDeniedException.class, () -> walletSecurity.hasReadAccess(userId, walletId));
  }
  ...
  void isWalletOwner_NoWalletAccess_ThrowsWalletNotFoundException() {
    when(walletAccessRepository.findByUserIdAndWalletId(userId, walletId))
        .thenReturn(Optional.empty());
    assertThrows(
        WalletNotFoundException.class, () -> walletSecurity.isWalletOwner(userId, walletId));
  }
  ...
  void hasWriteAccess_NoWalletAccess_ThrowsWalletNotFoundException() {
    when(walletAccessRepository.findByUserIdAndWalletId(userId, walletId))
        .thenReturn(Optional.empty());
    assertThrows(
        WalletNotFoundException.class, () -> walletSecurity.hasWriteAccess(userId, walletId));
  }
  ...
  void hasReadAccess_NoWalletAccess_ThrowsWalletNotFoundException() {
    when(walletAccessRepository.findByUserIdAndWalletId(userId, walletId))
        .thenReturn(Optional.empty());
    assertThrows(
        WalletNotFoundException.class, () -> walletSecurity.hasReadAccess(userId, walletId));
  }
}
