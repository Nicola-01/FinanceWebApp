...
class RegisterServiceTest {
  ...
  void getRegisterInvite_ValidToken_ReturnsResponse() {
    when(userInvitationRepository.findByToken("validToken"))
        .thenReturn(Optional.of(validRegistration));
  ...
  void registerViaInvite_ValidRequest_RegistersUser() {
    when(userInvitationRepository.findByToken("validToken"))
        .thenReturn(Optional.of(validRegistration));
    when(userRepository.findByUsernameIgnoreCaseOrEmailIgnoreCase("newuser", "newuser"))
  ...
  void getRegisterInvite_InvalidToken_ThrowsException() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> registerService.getRegisterInvite("badToken"));
  }
  ...
  void registerViaInvite_TokenNotFound_ThrowsException() {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> registerService.registerViaInvite("unknown", request));
  }
  ...
  void requestPasswordReset_EmailSendFails_ThrowsRuntimeException() throws Exception {
    ...
    assertThrows(
        RuntimeException.class, () -> registerService.requestPasswordReset("test@example.com"));
  }
  ...
  void getResetPasswordInvite_TokenNotFound_ThrowsException() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> registerService.getResetPasswordInvite("badReset"));
  }
  ...
  void getResetPasswordInvite_StatusNotForgotPassword_ThrowsException() {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> registerService.getResetPasswordInvite("wrongStatus"));
  }
  ...
  void getResetPasswordInvite_Expired_ThrowsException() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> registerService.getResetPasswordInvite("expired"));
  }
  ...
  void resetPassword_PasswordMismatch_ThrowsException() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> registerService.resetPassword("validToken", request));
  }
