...
class GlobalExceptionHandlerTest {
    ...
    void handleUserNotFoundException_Returns404() {
        ...
        ResponseEntity<ProblemDetail> response = exceptionHandler.handleUserNotFoundException(ex, request);
    ...
    void handleInvalidTokenException_Returns401() {
        ...
        ResponseEntity<ProblemDetail> response = exceptionHandler.handleInvalidTokenException(ex, request);
    ...
    void handleGenericException_DoesNotLeakInformation_Returns500() {
        ...
        Exception sensitiveException = new RuntimeException("Database connection failed for user postgres with password secretpassword");

        ResponseEntity<ProblemDetail> response = exceptionHandler.handleGenericException(sensitiveException, request);
