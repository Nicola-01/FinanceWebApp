...
class JwtAuthenticationFilterTest {
  ...
  @Test
  void doFilterInternal_AlreadyAuthenticated_CallsFilterChain()
  ...
  @Test
  void doFilterInternal_IsPatToken_CallsFilterChainAndIgnores()
      throws ServletException, IOException {
  ...
  @Test
  void doFilterInternal_IsRefreshToken_CallsFilterChainAndIgnores()
      throws ServletException, IOException {
  ...
  @Test
  void doFilterInternal_ExtractUsernameThrowsException_CallsFilterChain()
      throws ServletException, IOException {
  ...
  @Test
  void doFilterInternal_ValidTokenAndValidVersion_Authenticates()
      throws ServletException, IOException {
  ...
  @Test
  void doFilterInternal_ValidTokenButInvalidVersion_DoesNotAuthenticate()
      throws ServletException, IOException {
  ...
  @Test
  void doFilterInternal_TokenInvalidByJwtService_DoesNotAuthenticate()
      throws ServletException, IOException {
  ...
  @Test
  void doFilterInternal_UserDetailsNotInstanceOfUser_AuthenticatesWithoutVersionCheck()
      throws ServletException, IOException {
    String token = "valid_token";
    String username = "user@test.com";
  ...
  @Test
  void doFilterInternal_ExtractUsernameReturnsNull_DoesNotAuthenticate()
      throws ServletException, IOException {
