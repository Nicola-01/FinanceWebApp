...
/**
 * Base class for all @WebMvcTest classes.
 * We disable Spring Security filters to test only the web layer (validation, serialization, routing).
 */
@ActiveProfiles("test")
...
public abstract class BaseWebMvcTest {
    ...
    protected dev.busato.FinanceWebApp.backend.security.JwtAuthenticationFilter jwtAuthenticationFilter;

    @org.springframework.test.context.bean.override.mockito.MockitoBean
    protected dev.busato.FinanceWebApp.backend.security.PatAuthenticationFilter patAuthenticationFilter;
    ...
    public void setUpBase() throws Exception {
        ...
        org.mockito.Mockito.doAnswer(invocation -> {
            ...
            chain.doFilter(invocation.getArgument(0), invocation.getArgument(1));
            return null;
        }).when(patAuthenticationFilter).doFilter(org.mockito.ArgumentMatchers.any(), org.mockito.ArgumentMatchers.any(), org.mockito.ArgumentMatchers.any());
    }
