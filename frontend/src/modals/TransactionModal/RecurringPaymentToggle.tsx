        ...
        <div className="rounded-xl border border-app-border bg-black/20 p-4 transition-all">
            ...
            >
                <div className="flex items-center gap-3">
                    <div className={`flex h-10 w-10 items-center justify-center rounded-lg ${isRecurring ? 'bg-[#00ff7f]/20 text-[#00ff7f]' : 'bg-app-input text-app-muted'}`}>
                ...
                <div className={`relative w-12 h-6 rounded-full transition-colors ${isRecurring ? 'bg-[#00ff7f]' : 'bg-app-surface'}`}>
