        ...
        <div className="mb-10 rounded-xl border border-white/5 bg-white/[0.02] p-[25px]">
            ...
            <form className="grid grid-cols-1 items-center gap-[15px] lg:grid-cols-[minmax(200px,2fr)_minmax(200px,2fr)_auto]" onSubmit={handleCreate}>
                ...
                <div className="w-full relative">
                    ...
                    <input
                        type="search"
                        className="h-[50px] w-full rounded-[10px] border border-white/10 bg-black/30 pl-[40px] pr-[15px] py-3 text-[0.95rem] text-white outline-none transition-colors focus:border-[#00ff7f] [&::-webkit-search-cancel-button]:hidden"
                ...
                <div className="w-full relative">
                    ...
                    <input
                        type="text"
                        className="h-[50px] w-full rounded-[10px] border border-white/10 bg-black/30 pl-[40px] pr-[15px] py-3 text-[0.95rem] text-white outline-none transition-colors focus:border-[#00ff7f]"
