  ...
  return (
    <>
      <div
        ...
        className={`shrink-0 flex items-center justify-center border border-app-border bg-app-surface shadow-sm cursor-pointer hover:scale-110 transition-transform ${sizeClasses}`}
        style={{ color }}
