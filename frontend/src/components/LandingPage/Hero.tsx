    ...
    return (
        <header className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4 max-w-7xl mx-auto flex flex-col items-center text-center z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                {!isLoggedIn && (
                    <button onClick={onSecondaryCta} className="bg-white/5 border border-white/10 hover:bg-white/10 font-semibold py-4 px-8 rounded-full transition-all duration-300">
                        See What's Coming
                    </button>
                )}
            </div>
            ...
            <div className="mt-16 md:mt-24 w-full max-w-5xl relative hidden sm:flex justify-center">
                ...
                <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] overflow-hidden flex flex-col md:flex-row p-6 gap-6 items-start transform perspective-1000 rotate-x-12 scale-95 border-b-0 rounded-b-none w-full max-w-4xl">
                   ...
                   <div className="flex flex-col gap-4 w-full md:w-1/3">
                    {/* Selected Wallet */}
                    <div className="bg-white/10 rounded-xl p-4 border border-cyan-500/30 hidden md:block shadow-[0_0_20px_rgba(6,182,212,0.15)] transition-all">
                    ...
                    {/* Unselected Wallet */}
                    <div className="bg-white/5 rounded-xl p-4 border border-white/10 hidden md:block opacity-40 hover:opacity-60 transition-opacity">
                   ...
                   <div className="w-full md:w-2/3 bg-white/5 rounded-xl p-4 border border-white/10">
