...
const Hero: React.FC<HeroProps> = ({ isLoggedIn, demoEnabled, demoLoading, onMainCta, onSecondaryCta }) => {
    return (
        <header className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4 max-w-7xl mx-auto flex flex-col items-center text-center z-10">
            {/* <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-app-input border border-app-border text-cyan-300 text-sm font-medium mb-8 backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <button 
                    ...
                    className="bg-app-green text-black font-semibold py-4 px-8 rounded-full shadow-[0_0_24px_rgb(var(--app-green)/0.4)] hover:shadow-[0_0_32px_rgb(var(--app-green)/0.6)] hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
            ...
            <div className="mt-16 md:mt-24 w-full max-w-5xl relative hidden sm:flex justify-center">
                <div className="absolute inset-0 bg-gradient-to-t from-app-bg via-transparent to-transparent z-10 w-full h-[120%] bottom-[-20%]"></div>
                <div className="backdrop-blur-xl bg-app-input border border-app-border rounded-2xl shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] overflow-hidden flex flex-col md:flex-row p-6 gap-6 items-start transform perspective-1000 rotate-x-12 scale-95 border-b-0 rounded-b-none w-full max-w-4xl">
                   ...
                   <div className="flex flex-col gap-4 w-full md:w-1/3">
                    {/* Selected Wallet */}
                    <div className="bg-app-hover rounded-xl p-4 border border-cyan-500/30 hidden md:block shadow-[0_0_20px_rgb(var(--app-cyan)/0.15)] transition-all">
                        <div className="flex justify-between items-center mb-4">
                            <div className="h-4 w-1/2 bg-white/20 rounded"></div>
                            {/* <div className="h-2 w-2 rounded-full bg-cyan-400 animate-pulse"></div> */}
                        </div>
                        <div className="h-24 bg-gradient-to-br from-cyan-500/30 to-purple-500/30 rounded-lg mb-4"></div>
                    ...
                    <div className="bg-app-input rounded-xl p-4 border border-app-border hidden md:block opacity-40 hover:opacity-60 transition-opacity">
                        ...
                        <div className="h-24 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg mb-2"></div>
