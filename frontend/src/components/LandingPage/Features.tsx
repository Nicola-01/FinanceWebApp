        ...
        <section className="py-24 px-4 max-w-6xl mx-auto space-y-32 z-10 relative">
            ...
            <div className="flex flex-col md:flex-row items-center gap-24 md:gap-24">
                ...
                <div className="flex-1 relative perspective-1000 h-80 w-full flex justify-center items-center">
                    <div className="absolute transform translate-x-4 translate-y-4 rotate-12 bg-gradient-to-br from-pink-500/10 to-purple-500/10 border border-app-border backdrop-blur-md shadow-2xl p-6 rounded-2xl w-64 h-40 transition-transform hover:rotate-6 hover:translate-y-2 duration-500 cursor-default">
                    ...
                    <div className="absolute transform -translate-x-4 -rotate-6 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-app-border backdrop-blur-xl shadow-[0_10px_40px_-10px_rgba(0,255,255,0.2)] p-6 rounded-2xl w-72 h-44 z-10 transition-transform hover:rotate-0 hover:-translate-y-2 duration-500 cursor-default">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-24">
                ...
                <div className="flex-1 w-full order-2 md:order-1">
                    <div className="bg-app-input border border-app-border rounded-3xl p-6 backdrop-blur-sm shadow-xl w-full space-y-4">
                        <div className="flex flex-wrap sm:flex-nowrap items-center gap-4 bg-black/20 p-4 rounded-2xl border border-app-border hover:border-app-border transition-colors">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-app-input border border-app-border rounded-3xl p-8 backdrop-blur-sm hover:bg-app-hover transition-all hover:-translate-y-1 duration-300 relative overflow-hidden cursor-default">
                    ...
                    <div className="absolute -bottom-6 -right-6 flex -space-x-4 opacity-40 filter blur-[1px]">
                        <div className="w-16 h-16 rounded-full border-4 border-app-bg bg-cyan-500"></div>
                        <div className="w-16 h-16 rounded-full border-4 border-app-bg bg-purple-500"></div>
                        <div className="w-16 h-16 rounded-full border-4 border-app-bg bg-pink-500"></div>
                    </div>
                </div>
            </div>
        </section>
