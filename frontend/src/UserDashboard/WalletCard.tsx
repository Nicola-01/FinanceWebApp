...
const WalletCard: React.FC<WalletProps> = ({wallet, onDelete}) => {
    return (
        <div className="flex items-center gap-4 p-4 rounded-2xl border border-white/10 bg-[rgba(20,20,20,0.6)] backdrop-blur-md transition-transform hover:-translate-y-1 shrink-0 w-[260px] xl:w-full">
            <div
            ...
            <div className="flex flex-1 flex-col min-w-0">
                <h4 className="m-0 truncate font-mono text-sm font-extrabold text-white/50">
                    {wallet.name}
                </h4>
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    className="group relative z-20 flex h-9 w-9 items-center justify-center rounded-xl border border-transparent bg-white/5 text-white/40 transition-all duration-300 hover:border-amber-400/30 hover:bg-amber-400/10 hover:text-amber-400 hover:shadow-[0_0_15px_rgba(251,191,36,0.3)]"
                    title="Edit Wallet"
                >
