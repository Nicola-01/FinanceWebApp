...
export const SettingsTab: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-6 pb-6 animate-[fadeIn_0.3s_ease-out]">
        ...
        >
          ...
          <div className="flex flex-row gap-4 sm:gap-8 items-start sm:py-2">
            ...
            <div className="flex flex-col items-start gap-3 shrink-0">
              ...
              {/*    Color</label>*/}
              <div className="relative p-1 bg-app-input rounded-2xl border border-app-border shadow-inner self-start">
                <IconPickerButton
