...
export const OverviewRow: React.FC<OverviewRowProps> = ({ dataItems, border = true, getValue, type }) => {
    return (
        <tr className={`${border ? 'border-b border-app-border' : ''} hover:bg-app-surface/50 transition-colors`}>
            {dataItems.map((m, i) => (
