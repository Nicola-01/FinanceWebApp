...
export const AppHeader: React.FC<AppHeaderProps> = ({ page }) => {
    ...
    return (
        <header
            className="sticky top-0 z-40 flex h-16 w-full items-center justify-between border-b border-white/10 bg-[#0d0d12]/80 px-6 backdrop-blur-md">
            ...
            {/* Renderizziamo i Modali qui, così sono gestiti a livello di Header */}
